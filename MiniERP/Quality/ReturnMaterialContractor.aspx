<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ERP.Master" AutoEventWireup="true"
    CodeBehind="ReturnMaterialContractor.aspx.cs" ValidateRequest="false" Inherits="MiniERP.Quality.ReturnMaterialContractor" %>
            ...
            <div class="box-content">
                <asp:Panel ID="pnlSearch" runat="server">
                    <table class="table table-bordered table-striped table-condensed searchbg" style="border: 2px solid green;">
                        ...
                        <asp:DropDownList ID="ddlReturnmatcon" CssClass="TextBox" runat="server">
                    ...
                    <div class="mGriditem">
                        <asp:GridView ID="gvIssueMaterial" runat="server" AutoGenerateColumns="False" AllowPaging="false"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Specification">
                                  ...
                                  <asp:TemplateField HeaderText="Unit Measurement">
                                    <ItemTemplate>
                                      ...
                                      <asp:HiddenField ID="hdfUnitMeasurementName" runat="server" Value='<%# Eval("Item.ModelSpecification.UnitMeasurement.Name")%>' />
                                ...
                                <asp:TemplateField HeaderText="Per Unit Cost" Visible="false" ItemStyle-CssClass="taright">
                                    <ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Return Item Unit">
                                    <ItemTemplate>
                                   
                                        <asp:TextBox ID="txtReturnMaterial" runat="server" Text='<%#Eval("QuantityReturned") %>'></asp:TextBox>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Remarks">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRemark" runat="server" TextMode="MultiLine" MaxLength="250" Height="22px" Width="140px"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="center" width="25%">
                                    ...
                                    <asp:Label ID="lblIssudemandId" runat="server" Visible="false"></asp:Label>
                                ...
                                <td class="center" width="25%">
                                    ...
                                    <asp:Label ID="lblIssueDemandNumber" runat="server" Visible="false"></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td class="center">
                                    Return Material Contractor Date
                                </td>
                                <td class="center">
                    ...
                    <div>
                        <asp:GridView ID="gvReturnMaterialContractor" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="UnitLeft">
                                    <ItemTemplate>
                                        <asp:Label ID="lblUnitLeft" runat="server" Text='<%#Eval("UnitLeft") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Return Unit">
                                    <ItemTemplate>
                                        <asp:Label ID="lblRetunUnit" runat="server" Text='<%#Eval("QuantityReturned") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
