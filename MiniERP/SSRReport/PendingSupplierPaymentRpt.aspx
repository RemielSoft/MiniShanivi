<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Masters/ERP.Master"
    CodeBehind="PendingSupplierPaymentRpt.aspx.cs" Inherits="MiniERP.SSRReport.PendingSupplierPaymentRpt" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderMain" runat="server">
    ...
    <div style="margin-left: 50px;">
        <rsweb:ReportViewer ID="rptPendingSupplierPayment" runat="server" ShowParameterPrompts="false"
